  ...
  return (
    <label className="flex items-center cursor-pointer group">
      <div className="relative">
        ...
        <div className={`block w-14 h-8 rounded-full transition-all duration-300 ${isEnabled ? 'bg-gradient-to-r from-cyan-500 to-blue-500 shadow-lg shadow-blue-500/25' : 'bg-gray-600/50 border border-gray-500/30'}`}></div>
